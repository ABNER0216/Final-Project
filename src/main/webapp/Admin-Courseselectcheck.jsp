...
<%
String search = request.getParameter("day");
List<Course>listday = CourseDao.getAlldayRecord(search);
...
<div>
<h6>You can select the day that you want to add the:</h6>
<form action = "Admin-Courseselectcheck.jsp" method = "post">
        <div class="search-container">
           <form id="searchForm">
            <aclass="btn btn-outline-secondary btn-lg"style="padding: 5px 5px 5px 5px;" >Search by Day</a>
              <select name="day">
...
&nbsp;
<a class="btn btn-outline-secondary btn-lg"style="padding: 5px 5px 5px 5px;" href="Admin-Courseselectcheck.jsp">Refresh</a>
</div>


<c:forEach items="${listday}" var="u">
...
<h2>Here are all the courses in our system. </h2>
