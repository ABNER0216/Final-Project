...
List<Course>list = CourseDao.getMyStudentCourse(theStudent);
...
<nav class="navbar navbar-expand-md" >
	...
	<button class="navbar-toggler navbar-dark" class="btn btn-outline-secondary btn-lg"style="padding: 5px 5px 5px 5px;" type=button data-toggle="collapse" data-target="#main-navigation">
...
<c:forEach items="${list}" var="u">
	...
	<tr>
		...
		<td>${u.getCoach()}</td>
		<td>
		<form action="Student-MyCourseDetail.jsp" method="post">
