...
<nav class="navbar navbar-expand-md" >
	...
	<ul class="navbar-nav">
		...
		<li class="nav-item">
			<a class="nav-link"  href="Student-Place.jsp?studentid=<%=studentid%>">Back</a>
		</li>
	</ul>
	</div>
</nav>
...
<div id="theequip">
<form action="Student-RentSuccess.jsp" method="post">
 ...
 <input class="btn btn-outline-secondary btn-lg"style="padding: 5px 5px 5px 5px;"type="hidden" name="placeid" value="<%=pl.getPlaceId()%>"/>
 <table>
 
 <tr><td>StartDate:</td>
 <td><input class="btn btn-outline-secondary btn-lg"style="padding: 5px 5px 5px 5px;"type="date" name="StartDate" value="<%=pl.getStartDate()%>"/></td>
 </tr>
 <tr><td>EndDate:</td>   
 <td><input class="btn btn-outline-secondary btn-lg"style="padding: 5px 5px 5px 5px;"type="date" name="EndDate" value="<%=pl.getEndDate()%>"/></td>
 </tr>
