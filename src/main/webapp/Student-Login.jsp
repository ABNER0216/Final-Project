...
<form id="studentlogin" action="Student-LoginCheck.jsp" method="post">
	...
	<input class="btn btn-outline-secondary btn-lg"style="padding: 5px 5px 5px 5px;" id="studentsubmit" type="submit" value="Login">
