...
<form action="Student-Attend.jsp" method="post">
	<input type="hidden" name="studentid" value="<%=s.getStudentId()%>"/>
	<input type="hidden" name="courseid" value="<%=o.getCourseid()%>"/>
	<input id="listbutton" class="btn btn-outline-secondary btn-lg"style="padding: 1px 1px 1px 1px;" type="submit" name="submit" value="Attend"/>
</form>
