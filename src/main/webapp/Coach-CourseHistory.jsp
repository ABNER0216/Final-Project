...
<title>History Courses(Attend)</title>
...
<header>
<h1 style="text-align:center">History Course</h1>
</header>
...
List<Course>list = CourseDao.getMyHistoryCourse(theCoach);
...
<c:forEach items="${list}" var="u">
	...
	<tr>
		...
		<td>${u.getCoach()}</td>
		<td>
		<form action="Coach-MyHistoryCourseDetail.jsp" method="post">
